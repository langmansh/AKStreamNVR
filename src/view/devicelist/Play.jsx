...
import {StreamLive,GetMediaServerList} from "../../service/channel";
...
export default class Play extends React.Component {
    ...
    constructor(props) {
        ...
        const {channel,mediaServerId} = this.props;
        this.state = {
            playUrl:{},
            mediaServer: [],
    ...
    loadChannel = (params) => {
        StreamLive(this.state.mediaServerId,this.state.channel.stream).then(res => {
            ...
            <div className={"playback-play-container"}>
                ...
                <div className={"playback-play-header"}>
                    <div className={"playback-player"}>
                        ...
                        <AKStreamPlayer 
                            playUrl={this.state.playUrl.flv == undefined ? `${apiDomin}/rtp`+'/'+this.state.channel.stream+'.live.flv':this.state.playUrl.flv}
                            hasAudio={false}
                        />
